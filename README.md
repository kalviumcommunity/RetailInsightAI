...
This system analyses customer purchase behaviour from the Online Retail dataset,
segments customers into groups using K-Means clustering, calculates Customer
Lifetime Value, and surfaces targeted marketing recommendations through an
...
1. Raw transactions are cleaned (nulls, returns, and zero-price rows removed).
...
5. Customer Lifetime Value is derived as: CLV = (Monetary x Frequency) / (Recency + 1)
